...
class AuthenticationDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = [:id, :user, :provider, :uid].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = [:user, :id, :provider, :uid, :created_at, :updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = [:user, :provider, :uid].freeze
