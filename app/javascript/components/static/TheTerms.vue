  ...
  >
    <v-card class="terms">
      <v-card-text style="height: 90%;">
        ...
        <h2>第3条（ユーザー情報の管理）</h2>
        <p>
          当サービスでは、ユーザーのプライバシー情報と個人情報を、プライバシーポリシーに従って適切に取り扱います。
        </p>
        ...
        <h2>第8条（退会）</h2>
        <p>
          退会手続きにおいては, Twitter公式アカウント（@goenbako）へのダイレクトメッセージにてお問い合わせいただくことで本サービスの退会手続きを行うことができるものとします。
        </p>
        ...
        <h2>第10条（通知及び連絡）</h2>
        <p>
          本サービスからユーザーに対する通知及び連絡は，公式Twitterアカウント（@goenbako）からユーザーのTwitterアカウントに対するメンション及びダイレクトメッセージによって行うものとします。
        </p>
        <p>
